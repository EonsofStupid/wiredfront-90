 ...
 */
export function CoreTopBar({ className, isCompact, onToggleCompact }: TopBarProps) {
  ...
  return (
    <header 
      className={cn(
        "wf-core-topbar h-16 border-b border-neon-blue/20 glass-card px-6 relative", 
        className
      )}
      style={{ zIndex: LayoutZIndex.navbar }}
      data-testid="core-topbar"
    >
      <div className="h-full flex items-center justify-between">
        ...
        <TooltipProvider delayDuration={0}>
          <div className="flex items-center gap-4">
            ...
            <div className="relative" style={{ zIndex: LayoutZIndex.userMenu }}>
              <UserMenu />
            </div>
          </div>
        </TooltipProvider>
