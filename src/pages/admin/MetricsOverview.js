...
export default function MetricsOverview() {
    ...
    if (isLoading) {
        return (_jsx("div", { className: "admin-container", children: _jsx(SettingsContainer, { title: "System Metrics", description: "Loading metrics...", children: _jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4", children: [...Array(6)].map((_, i) => (_jsx(Skeleton, { className: "h-32" }, i))) }) }) }));
    }
    return (_jsxs("div", { className: "admin-container", children: [_jsxs(SettingsContainer, { title: "System Metrics", description: "Real-time system metrics and performance indicators", children: [_jsx(DashboardHeader, { timeRange: timeRange, onTimeRangeChange: handleTimeRangeChange, onRefresh: refreshData }), _jsx(MetricsTabs, { activeTab: activeTab, onTabChange: setActiveTab, tabs: availableTabs }), _jsxs("div", { className: "space-y-8", children: [_jsx(KPICardsGrid, { metrics: metrics, revenueMetric: revenueMetric, onMetricClick: handleMetricClick, getMetricIcon: getMetricIcon, isLoading: isRefreshing || isFetching }), (activeTab === "overview" || activeTab === "performance") && (_jsx(PerformanceChart, {})), (activeTab === "overview" || activeTab === "system") && (_jsx(SystemStatusPanel, {})), activeTab === "financials" && (_jsx(FinancialMetricsPanel, { revenueMetric: revenueMetric }))] })] }), _jsx(MetricDetailsDialog, { open: isDetailsOpen, onOpenChange: setIsDetailsOpen, metric: selectedMetric })] }));
}
