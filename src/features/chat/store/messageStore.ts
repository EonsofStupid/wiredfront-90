...
import { MessageRole, MessageStatus } from '@/types/chat/core';
import { EnhancedChatMessage, Message } from '@/types/chat/messages';
          ...
          try {
            ...
            set((state) => ({
              ...
              messages: state.messages.map(msg =>
                msg.content === content && msg.status === 'pending'
                  ? { ...msg, status: 'failed' }
                  : msg
              )
            }));
