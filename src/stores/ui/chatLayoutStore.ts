...
export const uiPreferencesAtom = atomWithStorage<ChatUIPreferences>('chat-ui-preferences', defaultUIPreferences);
...
export const updateUIPreferencesAtom = atom(
  null,
  (get, set, preferences: Partial<ChatUIPreferences>) => {
