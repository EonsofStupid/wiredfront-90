 ...
 */
export const logFeatureToggle = async (featureName, newValue, oldValue) => {
    try {
 ...
 */
export const logProviderChange = async (oldProvider, newProvider) => {
    try {
 ...
 */
export const logCommandUsage = async (commandName, args) => {
    try {
