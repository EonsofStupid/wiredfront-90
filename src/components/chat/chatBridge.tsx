...
export const useSessionStore = () => {
  ...
  return {
    // Map conversation data to "session" terminology for backward compat
    sessions: conversations,
    currentSessionId: currentConversationId,
    user: { id: 'current-user' }, // Placeholder for auth integration
    
    // Bridge methods mapped to session terminology
    createSession: bridge.createConversation,
    switchSession: bridge.switchConversation,
    updateSession: bridge.updateConversation,
    archiveSession: bridge.archiveConversation
  };
};
