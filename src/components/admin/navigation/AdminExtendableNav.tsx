...
import { ChevronUp, ChevronDown, Users, Database, Settings, Shield, Key } from "lucide-react";
import { cn } from "@/lib/utils";
import { Button } from "@/components/ui/button";
import { Tooltip, TooltipContent, TooltipProvider, TooltipTrigger } from "@/components/ui/tooltip";

interface AdminExtendableNavProps {
  className?: string;
}

export const AdminExtendableNav = ({ className }: AdminExtendableNavProps) => {
