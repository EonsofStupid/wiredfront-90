...
describe("LogItem", () => {
    ...
    it("renders log information correctly", () => {
        render(_jsx(LogItem, { log: mockLog, isExpanded: false, onToggleExpand: vi.fn() }));
    ...
    it("shows metadata when expanded", () => {
        render(_jsx(LogItem, { log: mockLog, isExpanded: true, onToggleExpand: vi.fn() }));
    ...
    it("calls toggle function when clicked", () => {
        ...
        render(_jsx(LogItem, { log: mockLog, isExpanded: false, onToggleExpand: mockToggle }));
    ...
    it("applies different icon and badge color based on log level", () => {
        ...
        const { rerender } = render(_jsx(LogItem, { log: mockLog, isExpanded: false, onToggleExpand: vi.fn() }));
        ...
        rerender(_jsx(LogItem, { log: errorLog, isExpanded: false, onToggleExpand: vi.fn() }));
