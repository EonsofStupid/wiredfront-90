...
const AdminTooltipContent = React.forwardRef(({ className, sideOffset = 4, ...props }, ref) => (_jsx(TooltipPrimitive.Content, { ref: ref, sideOffset: sideOffset, className: cn(
    // Base styles
    ...
    "border border-white/20 px-3 py-2 text-sm font-medium", "bg-gradient-to-r from-[#8B5CF6]/90 to-[#D946EF]/90 text-white backdrop-blur-md", "admin-tooltip-content", className), ...props })));
