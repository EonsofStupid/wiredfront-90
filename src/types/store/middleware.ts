...
// Corrected to properly extend StateStorage
export interface CustomStateStorage extends Omit<StateStorage, 'getItem'> {
  getItem: <T>(name: string) => string | null | Promise<string | null>;
