...
import { dockedAtom, positionAtom, dockedItemsAtom, toggleDockedAtom, setDockedItemAtom, resetDockingAtom, saveDockingToStorageAtom, loadDockingFromStorageAtom, initializeDockingAtom, dockingStateAtom } from '@/stores/ui/chatDockingStore';
/**
...
export function useJotaiChatDocking() {
     ...
     */
    const setDockPosition = (id, position) => {
