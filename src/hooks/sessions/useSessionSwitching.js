 ...
 */
export function useSessionSwitching(setCurrentSessionId, fetchSessionMessages, setSessionLoading, currentSessionId) {
    const queryClient = useQueryClient();
    const { mutateAsync: switchSession } = useMutation({
        mutationFn: (sessionId) => switchToSession(sessionId),
